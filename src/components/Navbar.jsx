...
const Header =() => {
  ...
  return (
    <div id="navbar">
      <div class="navbar-LogoAndSearch">
        <Link to="/">
          <img src="https://i.ibb.co/72dN4JJ/Facebook-icon-2019-1.png" class="navbar__logo" />
        </Link>
        <div class="navbar__searchBack" onClick={collapseNavbar}>
          <i class="searchBackIcon" />
        </div>
        <div class="navbar__search" onClick={expandNavbar}>
          <i class="searchIcon" />
        </div>
      ...
      <div class="navbar__otherIcons">
        ...
        <div class="round" onClick={renderProfile}>
          <i class={`dropdownIcon ${profileDown === true}`} />
